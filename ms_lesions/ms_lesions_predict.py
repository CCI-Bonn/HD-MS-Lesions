...
def main():
    parser = argparse.ArgumentParser(description="This script will allow you to predict MS lesions of a single case that comes with the following modalities (with index):\n"
                                                 ...
                                                 "To predict all cases in a directory, please use `ms_lesions_predict_folder` (this one "
    ...
    parser.add_argument("-id", type=str, required=True,
                        help="Identifier of the input file (if the file ends with .nii.gz id is extracted automatically. All expected modalities of the id must exist.")
    ...
    input_paths, output_file = prepare_input_args_t1ce(inp_dir, inp_id, output_dir, output_id, skip_modality)

    predict_cases(model=folder_with_t1ce_parameter_files,
                  list_of_lists=[input_paths],
